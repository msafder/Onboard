...
- (void)viewWillLayoutSubviews {
    ...
    self.pageControl.frame = CGRectMake(0, CGRectGetMaxY(self.view.frame) - self.underPageControlPadding - kPageControlHeight - 8, self.view.frame.size.width, kPageControlHeight);
}
